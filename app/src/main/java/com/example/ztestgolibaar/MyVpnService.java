...
public class MyVpnService extends VpnService implements Handler.Callback {
    ...
    public static final String ACTION_CONNECT = "com.example.android.ztestgolibaar.START";
    public static final String ACTION_DISCONNECT = "com.example.android.ztestgolibaar.STOP";
